...
export default function BahanAjar(){
    ...
    <section class="bg-transparent">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
            <div>
                <iframe class="mx-auto w-full lg:max-w-xl h-64 rounded-2xl sm:h-96 shadow-xl" src="https://drive.google.com/file/d/13vItj8HabX3052r3PVheZF41Y-7hGBV6/preview" ></iframe>
            </div>

...
function Blog() {
    ...
    if (!content) {
        ...
        <div className='flex justify-center items-center mt-20 mb-20'>
            <button disabled type="button" className="text-white bg-[#03346E] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-3 text-center me-2 a inline-flex items-center">
    ...
    return (
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-left lg:py-16">
            <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-[#03346E] md:text-5xl lg:text-6xl">{content.title}</h1>

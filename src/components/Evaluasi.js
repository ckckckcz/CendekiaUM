...
export default function Evaluasi() {
    return (
        <>
        <section class="bg-[#03346E] flex items-center justify-center">
            <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                ...
                <div class="inline-flex items-center justify-center w-full">
                    ...
                    <span class="absolute px-3 font-medium text-white -translate-x-1/2 bg-[#03346E] left-1/2 ">atau</span>
                </div>
                <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                    <a href="https://quizizz.com/join?gc=50801760" target="_blank" class="py-3 px-5 sm:ms-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-[#03346E] focus:z-10 focus:ring-4 focus:ring-gray-100">
                        Mulai Quiz !
                    </a>  
                </div>
            </div>
